...
$catalogue = new MessageCatalogue('zh_CN', array (
  ...
  array (
    ...
    'Remember Me' => '记住我',
    'Sign in to start your session' => '登录',
    'Sign In' => '登录',
    'Sign out' => '注销',
    'Register' => '注册',
    'Profile' => '个人资料',
    'Member since %date%' => '会员资格始于 %date%',
    'Username' => '用户名',
    ...
    'Register a new account' => '注册新帐户',
    'View all' => '查看所有',
    'You have %count% notifications' => '您有 %count% 个通知',
    'You have %count% messages' => '您有 %count% 条消息',
    'You have %count% tasks' => '您有 %count% 项任务',
    '%progress%% Complete' => '%progress%% 完成',
    'This is a mandatory field' => '该处为必填项',
