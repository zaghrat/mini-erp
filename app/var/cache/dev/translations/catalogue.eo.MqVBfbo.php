...
$catalogue = new MessageCatalogue('eo', array (
  'AdminLTEBundle' => 
  array (
    'Toggle navigation' => 'Baskuligi navigadon',
    'Remember Me' => 'Resti ensalutinta',
    'Sign in to start your session' => 'Ensaluti',
    'Sign In' => 'Ensaluti',
    'Sign out' => 'Elsaluti',
    'Register' => 'Registriĝi',
    'Profile' => 'Via profilo',
    'Member since %date%' => 'Membro ekde %date%',
    'Username' => 'Uzantnomo',
    'Username or email address' => 'Uzantnomo aŭ retpoŝtadreso',
    'Password' => 'Pasvorto',
    'Show homepage' => 'Montri hejmpaĝon',
    'Back to login' => 'Reen al ensaluto',
    'Reset your password' => 'Restarigi vian pasvorton',
    'I forgot my password' => 'Mi forgesis mian pasvorton',
    'Register a new account' => 'Registri novan konton',
    'View all' => 'Vidi ĉiujn',
    'You have %count% notifications' => 'Vi havas unu sciigon|Vi havas %count% sciigojn',
    'You have %count% messages' => 'Vi havas 1 mesaĝon|Vi havas %count% mesaĝojn',
    'You have %count% tasks' => 'Vi havas 1 taskon|Vi havas %count% taskojn',
    '%progress%% Complete' => '%progress%% kompleta',
    'This is a mandatory field' => 'Tio ĉi estas deviga kampo',
