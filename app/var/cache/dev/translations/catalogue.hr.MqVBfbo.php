...
$catalogue = new MessageCatalogue('hr', array (
  ...
  array (
    ...
    'Sign in to start your session' => 'Prijavi se',
    'Sign In' => 'Prijavi se',
    'Sign out' => 'Odjavi se',
    'Register' => 'Registriraj se',
    'Profile' => 'Tvoj profil',
    'Member since %date%' => 'Član od %date%',
    'Username' => 'Korisničko ime',
    'Username or email address' => 'Korisničko ime ili e-mail adresa',
    'Password' => 'Lozinka',
    'Show homepage' => 'Pokaži web-stranicu',
    'Back to login' => 'Natrag na prijavu',
    'Reset your password' => 'Obnovi lozinku',
    'I forgot my password' => 'Ne sjećam se lozinke',
    'Register a new account' => 'Registriraj novi račun',
    'View all' => 'Prikaži sve',
    'You have %count% notifications' => 'Imaš %count% obavijest|Imaš %count% obavijesti|Imaš %count% obavijesti',
    'You have %count% messages' => 'Imaš %count% poruku|Imaš %count% poruke|Imaš %count% poruka',
    'You have %count% tasks' => 'Imaš %count% zadatak|Imaš %count% zadatka|Imaš %count% zadataka',
    '%progress%% Complete' => '%progress% % završeno',
    'This is a mandatory field' => 'Ovo je obavezno polje',
    'registration.confirmed' => 'Čestitamo %username%, tvoj je račun sada aktiviran.',
  ),
));
