...
$catalogue = new MessageCatalogue('it', array (
  ...
  'AdminLTEBundle' => 
  array (
    'Toggle navigation' => 'Cambia visualizzazione della barra laterale',
    ...
    'Member since %date%' => 'Membro da %date%',
    'Username' => 'Nome utente',
    'Username or email address' => 'Username o indirizzo email',
    'Password' => 'Password',
    ...
    'You have %count% notifications' => 'Hai 1 notifica|Hai %count% notifiche',
    'You have %count% messages' => 'Hai 1 messaggio|Hai %count% messaggi',
    'You have %count% tasks' => 'Hai 1 compito|Hai %count% compiti',
    '%progress%% Complete' => '%progress%% completato',
