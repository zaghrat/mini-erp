...
$catalogue = new MessageCatalogue('pl', array (
  ...
  array (
    ...
    'Profile' => 'Twój profil',
    'Member since %date%' => 'Konto utworzone  %date%',
    'Username' => 'Nazwa użytkownika',
    'Username or email address' => 'Nazwa użytkownika lub e-mail',
    'Password' => 'Hasło',
    'Show homepage' => 'Pokaż stronę startową',
    'Back to login' => 'Powrót do strony logowania',
    'Reset your password' => 'Reset hasła',
    'I forgot my password' => 'Zapomniałem mojego hasła',
    'Register a new account' => 'Zarejestruj nowe konto',
    'View all' => 'Pokaż wszystko',
    'You have %count% notifications' => 'Masz 1 powiadomienie|Masz %count% powiadomień|Masz %count% powiadomień',
    'You have %count% messages' => 'Masz  1 wiadomość|Masz %count% wiadomości|Masz %count% wiadomości',
    'You have %count% tasks' => 'Masz 1 zadanie|Masz %count% zadań|Masz %count% zadań',
    '%progress%% Complete' => '%progress%% ukończenia',
    'This is a mandatory field' => 'To pole jest obowiązkowe',
