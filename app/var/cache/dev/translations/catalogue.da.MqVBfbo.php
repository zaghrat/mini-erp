...
$catalogue = new MessageCatalogue('da', array (
  ...
  array (
    ...
    'Sign in to start your session' => 'Log ind',
    'Sign In' => 'Log ind',
    'Sign out' => 'Log ud',
    'Register' => 'Registrer',
    'Profile' => 'Din profil',
    'Member since %date%' => 'Medlem siden %date%',
    'Username' => 'Brugernavn',
    'Username or email address' => 'Brugernavn eller e-mailadresse',
    'Password' => 'Kodeord',
    'Show homepage' => 'Vis hjemmeside',
    'Back to login' => 'Tilbage til login',
    'Reset your password' => 'Nulstil dit kodeord',
    'I forgot my password' => 'Glemt kodeord?',
    'Register a new account' => 'Opret ny bruger',
    'View all' => 'Vis alle',
    'You have %count% notifications' => 'Du har 1 notifikation|Du har %count% notifikationer',
    'You have %count% messages' => 'Du har 1 besked|Du har %count% beskeder',
    'You have %count% tasks' => 'Du har 1 opgave|Du har %count% opgaver',
    '%progress%% Complete' => '%progress%% færdiggjort',
    'This is a mandatory field' => 'Dette er et obligatorisk felt',
