...
$catalogue = new MessageCatalogue('ro', array (
  ...
  'AdminLTEBundle' => 
  array (
    'Toggle navigation' => 'Comută navigația',
    'Remember Me' => 'Amintește-ți de mine',
    'Sign in to start your session' => 'Conectare',
    'Sign In' => 'Autentificare',
    'Sign out' => 'Deconectare',
    'Register' => 'Înregistrează-te',
    'Profile' => 'Profilul tău',
    'Member since %date%' => 'Membru din data de %date%',
    'Username' => 'Nume de utilizator',
    'Username or email address' => 'Numele de utilizator sau adresa de email',
    'Password' => 'Parola',
    'Show homepage' => 'Mergi la pagina de pornire',
    'Back to login' => 'Înapoi la pagina de autentificare',
    'Reset your password' => 'Resetare parolă',
    'I forgot my password' => 'Mi-am uitat parola',
    'Register a new account' => 'Înregistrază un cont nou de utilizator',
    'View all' => 'Vezi tot',
    'You have %count% notifications' => 'Ai o notificare|Ai %count% notificări',
    'You have %count% messages' => 'Ai un mesaj nou|Ai %count% mesaje',
    'You have %count% tasks' => 'Ai un task|Ai %count% task-uri',
    '%progress%% Complete' => '%progress%% completat',
    'This is a mandatory field' => 'Acesta este un câmp obligatoriu',
