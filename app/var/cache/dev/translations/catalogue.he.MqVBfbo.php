...
$catalogue = new MessageCatalogue('he', array (
  ...
  array (
    ...
    'Sign in to start your session' => 'כניסה',
    'Sign In' => 'התחבר',
    'Sign out' => 'התנתק',
    'Register' => 'הרשם',
    'Profile' => 'הפרופיל שלך',
    'Member since %date%' => 'חבר מאז %date%',
    'Username' => 'שם משתמש',
    'Username or email address' => 'שם משתמש או דואר אלקטרוני',
    'Password' => 'סיסמה',
    'Show homepage' => 'הצג את דף הבית',
    'Back to login' => 'חזרה למסך הכניסה',
    'Reset your password' => 'איפוס סיסמה',
    'I forgot my password' => 'שכחתי סיסמה',
    'Register a new account' => 'הירשם למערכת',
    'View all' => 'צפה בהכל',
    'You have %count% notifications' => 'יש לך תזכורת 1|יש לך %count% תזכורות',
    'You have %count% messages' => 'יש לך הודעה 1|יש לך %count% הודעות',
    'You have %count% tasks' => 'יש לך משימה 1|יש לך %count% משימות',
    '%progress%% Complete' => '%progress%% הושלם',
