...
$catalogue = new MessageCatalogue('sk', array (
  ...
  array (
    ...
    'Remember Me' => 'Pamätať si ma',
    'Sign in to start your session' => 'Prihláste sa pre začatie sedenia',
    'Sign In' => 'Prihlásiť sa',
    'Sign out' => 'Odhlásiť sa',
    'Register' => 'Registrácia',
    'Profile' => 'Profil',
    'Member since %date%' => 'Členom od %date%',
    'Username' => 'Používateľ',
    'Username or email address' => 'Používateľské meno alebo emailová adresa',
    'Password' => 'Heslo',
    'Show homepage' => 'Hlavná stránka',
    'Back to login' => 'Späť na prihlásenie',
    'Reset your password' => 'Resetovať heslo',
    'I forgot my password' => 'Zabudol som heslo',
    'Register a new account' => 'Zaregistrovať nové konto',
    'View all' => 'Zobraziť všetky',
    'You have %count% notifications' => 'Máte jednu notifikáciu|Máte %count% notifikácie|Máte %count% notifikácie',
    'You have %count% messages' => 'Máte 1 správu|Máte %count% správ|Máte %count% správ',
    'You have %count% tasks' => 'Máte 1 úlohu|Máte %count% úloh|Máte %count% úloh',
    '%progress%% Complete' => '%progress%% hotovo',
    'This is a mandatory field' => 'Toto pole je povinné',
