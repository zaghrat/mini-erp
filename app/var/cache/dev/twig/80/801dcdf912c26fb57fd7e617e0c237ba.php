...
class __TwigTemplate_c87cf354ab836106659defbc5c969085 extends Template
{
    private $source;
    private $macros = [];
...
{% macro session_flash(close, use_raw, class, domain) %}
    ...
    {% endif %}
{% endmacro %}
", "@AdminLTE/Macros/default.html.twig", "/var/www/app/vendor/kevinpapst/adminlte-bundle/Resources/views/Macros/default.html.twig");
    }
}
