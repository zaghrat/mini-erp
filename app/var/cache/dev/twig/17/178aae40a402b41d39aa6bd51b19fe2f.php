...
class __TwigTemplate_f192d3bed723dbf2c4b87386f42a0105 extends Template
{
    private $source;
    private $macros = [];
...
{% macro menu_item_content(item, defaultIcon) %}
    ...
    {% endif %}
{% endmacro %}
", "@AdminLTE/Macros/menu.html.twig", "/var/www/app/vendor/kevinpapst/adminlte-bundle/Resources/views/Macros/menu.html.twig");
    }
}
