...
$catalogue = new MessageCatalogue('el', array (
  ...
  array (
    ...
    'Remember Me' => 'Αποθήκευση συνεδρίας',
    'Sign in to start your session' => 'Συνδεθείτε για εκίνηση συνεδρίας',
    'Sign In' => 'Σύνδεση',
    'Sign out' => 'Αποσύνδεση',
    'Register' => 'Εγγραφή',
    ...
    'Username or email address' => 'Επαναφορά του κωδικού πρόσβασης',
    'Password' => 'Κωδικός πρόσβασης',
    'Show homepage' => 'Εμφάνιση αρχικής σελίδας',
    'Back to login' => 'Πίσω στη σελίδα σύνδεσης',
    'Reset your password' => 'Επαναπροσδιορισμός κωδικού πρόσβασης',
    'I forgot my password' => 'Ξέχασα τον κωδικό πρόσβασης μου',
    'Register a new account' => 'Δημιουργία νέου λογαριασμού',
    'View all' => 'Προβολή  όλων',
    'You have %count% notifications' => 'Έχετε 1 ειδοποίηση|Έχετε %count% ειδοποιήσεις',
    'You have %count% messages' => 'Έχετε 1 μήνυμα|Έχετε %count% μηνύματα',
    'You have %count% tasks' => 'Έχετε 1 ανάθεση|Έχετε %count% αναθέσεις',
    '%progress%% Complete' => '%progress%% Ολοκληρώθηκε',
    'This is a mandatory field' => 'Αυτό είναι υποχρεωτικό πεδίο',
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'you did not type the same password' => 'you did not type the same password',
    'There is already an account with this email' => 'There is already an account with this email',
  ...
  array (
    ...
    'Email' => 'Email',
    'Your Address mail here' => 'Your Address mail here',
    'There is already an account with this email' => 'There is already an account with this email',
    'Password' => 'Password',
