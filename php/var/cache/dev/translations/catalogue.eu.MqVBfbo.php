...
$catalogue = new MessageCatalogue('eu', array (
  ...
  'AdminLTEBundle' => 
  array (
    'Toggle navigation' => 'Nabigazioa aktibatu',
    'Remember Me' => 'Gogora nazazu',
    'Sign in to start your session' => 'Izena ta pasahitza sartu saioa hasteko',
    'Sign In' => 'Saioa hasi',
    'Sign out' => 'Saioa itxi',
    'Register' => 'Izena eman',
    'Profile' => 'Nire kontua',
    'Member since %date%' => '%date%-tik erabiltzailea ',
    'Username' => 'Erabiltzailea',
    'Username or email address' => 'Erabiltzaile izena',
    'Password' => 'Pasahitza',
    'Show homepage' => 'Hasierako orria',
    'Back to login' => 'Saio hasierara itzuli',
    'Reset your password' => 'Pasahitza berrezarri',
    'I forgot my password' => 'Pasahitza ahaztu dut',
    'Register a new account' => 'Kontu berria sortu',
    'View all' => 'Dena ikusi',
    'You have %count% notifications' => 'Jakinarazpen bat daukazu|%count% jakinarazpen dauzkazu',
    'You have %count% messages' => 'Mezu bat daukazu|%count% mezu dauzkazu',
    'You have %count% tasks' => 'Lan bat daukazu|%count% lan dauzkazu',
    '%progress%% Complete' => '%%progress% egina',
    'This is a mandatory field' => 'Derrigorezko sarrera',
